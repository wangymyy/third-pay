package com.lin.ym.thirdpay.factory.wx;

import com.lin.ym.thirdpay.util.MD5Util;
...
public class PayCommonUtil {
    ...
    protected static final Logger logger = LoggerFactory.getLogger(PayCommonUtil.class);
    //微信参数配置
    @Value(value = "${WX_APP_KEY}")
